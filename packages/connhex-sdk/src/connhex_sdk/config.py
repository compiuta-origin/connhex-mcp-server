...
class CoreSettings(BaseSettings):
    """Connection settings shared by every Connhex client (MCP server, CLI, ...).

    Subclasses extend this with application-specific options. Core itself
    never instantiates this directly.
    """
