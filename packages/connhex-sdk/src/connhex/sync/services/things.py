...
class ThingsService:
    ...
    def get(self, thing_id: str) -> Thing:
        resp = self.client.request("GET", f"/iot/things/{thing_id}")
    ...
    def list(
        ...
        *,
        ...
        if dir is not None:
            params["dir"] = dir
        resp = self.client.request("GET", "/iot/things", params=params)
        return ThingsPage.model_validate(resp.json())

    def get_status(self, ids: list[str]) -> BatchStatusRes:
    ...
    def get_status_summary(self) -> StatusSummary:
        resp = self.client.request("GET", "/iot/things/status/summary")
